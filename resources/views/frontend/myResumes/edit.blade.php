    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.my-resumes.update", [$myResume->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="resume">{{ trans('cruds.myResume.fields.resume') }}</label>
                            <textarea class="form-control" name="resume" id="resume" required>{{ old('resume', $myResume->resume) }}</textarea>
