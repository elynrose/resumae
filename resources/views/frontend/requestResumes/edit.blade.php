    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.request-resumes.update", [$requestResume->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="accepted" id="accepted" value="1" {{ $requestResume->accepted || old('accepted', 0) === 1 ? 'checked' : '' }}>
