...
class JobPostingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.jobPostings.index', compact('jobPostings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.jobPostings.create', compact('job_categories'));
    }
    ...
    public function store(StoreJobPostingRequest $request)
    {
        ...
        return redirect()->route('frontend.job-postings.index');
    }
    ...
    public function edit(JobPosting $jobPosting)
    {
        ...
        return view('frontend.jobPostings.edit', compact('jobPosting', 'job_categories'));
    }
    ...
    public function show(JobPosting $jobPosting)
    {
        ...
        return view('frontend.jobPostings.show', compact('jobPosting'));
    }
