...
class RequestResumeController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.requestResumes.index', compact('requestResumes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.requestResumes.create', compact('resumes', 'users'));
    }
    ...
    public function store(StoreRequestResumeRequest $request)
    {
        ...
        return redirect()->route('frontend.request-resumes.index');
    }
    ...
    public function edit(RequestResume $requestResume)
    {
        ...
        return view('frontend.requestResumes.edit', compact('requestResume', 'resumes', 'users'));
    }
    ...
    public function show(RequestResume $requestResume)
    {
        ...
        return view('frontend.requestResumes.show', compact('requestResume'));
    }
