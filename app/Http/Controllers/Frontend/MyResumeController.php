...
class MyResumeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.myResumes.index', compact('myResumes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.myResumes.create', compact('users'));
    }
    ...
    public function store(StoreMyResumeRequest $request)
    {
        ...
        return redirect()->route('frontend.my-resumes.index');
    }
    ...
    public function edit(MyResume $myResume)
    {
        ...
        return view('frontend.myResumes.edit', compact('myResume', 'users'));
    }
    ...
    public function show(MyResume $myResume)
    {
        ...
        return view('frontend.myResumes.show', compact('myResume'));
    }
