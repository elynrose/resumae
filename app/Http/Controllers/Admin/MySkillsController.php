...
class MySkillsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.mySkills.index', compact('mySkills'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.mySkills.create', compact('job_categories', 'my_resumes', 'skills', 'users'));
    }
    ...
    public function store(StoreMySkillRequest $request)
    {
        ...
        return redirect()->route('admin.my-skills.index');
    }
    ...
    public function edit(MySkill $mySkill)
    {
        ...
        return view('admin.mySkills.edit', compact('job_categories', 'mySkill', 'my_resumes', 'skills', 'users'));
    }
    ...
    public function show(MySkill $mySkill)
    {
        ...
        return view('admin.mySkills.show', compact('mySkill'));
    }
