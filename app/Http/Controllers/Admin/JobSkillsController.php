...
class JobSkillsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.jobSkills.index', compact('jobSkills'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.jobSkills.create', compact('job_postings'));
    }
    ...
    public function store(StoreJobSkillRequest $request)
    {
        ...
        return redirect()->route('admin.job-skills.index');
    }
    ...
    public function edit(JobSkill $jobSkill)
    {
        ...
        return view('admin.jobSkills.edit', compact('jobSkill', 'job_postings'));
    }
    ...
    public function show(JobSkill $jobSkill)
    {
        ...
        return view('admin.jobSkills.show', compact('jobSkill'));
    }
